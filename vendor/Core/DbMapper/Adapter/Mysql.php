 ...
 */
class Core_DbMapper_Adapter_Mysql extends Core_DbMapper_Adapter_PDO_BaseAbstract implements Core_DbMapper_Adapter_AdapterInterface
{
    ...
    public function migrateSyntaxFieldCreate($fieldName, array $fieldInfo)
    {
        ...
        $typeHandler = Core_DbMapper_Config::typeHandler($fieldInfo['type']);
