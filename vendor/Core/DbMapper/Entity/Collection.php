...
/**
 * Core_DbMapper_Collection of Spot_Entity objects
 *
 * @package Spot
 * @link http://spot.os.ly
 */
class Core_DbMapper_Entity_Collection implements Iterator, Countable, ArrayAccess
{
    ...
    */
    ...
    /**
     * Implementado devido ao erro no PHP 5.2 na função ArrayAccess::offsetGet
     * @return array
     */
    ...
    */
    public function merge(Core_DbMapper_Entity_Collection $collection, $onlyUnique = true)
    {
    ...
    /**
     * Return an array representation of the Core_DbMapper_Collection.
     *
